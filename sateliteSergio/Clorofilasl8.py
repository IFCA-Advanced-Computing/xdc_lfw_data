# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 10:28:33 2018

@author: Win10 User

Cross-Validation clorofilas
"""
...
fecha_i=datetime.date(year=2014,month=1,day=1)
...
geometry = ee.Geometry.Polygon(
       ...
       [[-2.7059, 41.8727], [-2.7056, 41.8727], [-2.7056, 41.8724], [-2.7059, 41.8724]]);
...
for i in range (66):
    ...
    path4 =cloros.getDownloadURL({
      ...
      'region':'[[-2.7059, 41.8727], [-2.7056, 41.8727], [-2.7056, 41.8724], [-2.7059, 41.8724]]'    
    })
