...
class DOS1_landsat(object):

    def _init_(self, date_path, region):
        """
    ...
    def cut_tiff(self):
        ...
        #En el config
        coord = config.regions[self.region]["coordinates"]
...
#date_path = '/data/CdP/LC08_L1TP_200031_20170331_20170414_01_T1'
#region = 'CdP'

#d = DOS1_landsat()
#d._init_(date_path, region)
